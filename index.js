...
var hangman = {
  ...
  newGame: function() {
    ...
    if (this.guessesLeft === 15) {
      ...
      console.log(this.wordToGuess.wordDisplay());
      this.userPrompt();
   	} else {
     ...
     var attemptedGuesses = false;
        ...
        if (attemptedGuesses === false) {
          ...
          if (foundLetter === 0) {
            ...
            console.log("\n~~~~~~~~~~~~~~~~~~~~~~~");
            console.log(that.wordToGuess.wordDisplay());
            console.log('\n~~~~~~~~~~~~~~~~~~~~~~~');
            ...
            console.log("Correct, good job!");
              ...
              if (that.wordToGuess.correctGuess() === true) {
                ...
                console.log("Guesses left: " + that.guessesLeft);
                console.log(that.wordToGuess.diplayWord());
                console.log("\n~~~~~~~~~~~~~~~~~~~~~");
                console.log("Letters already guessed: " + that.guessedLetters);
              }
          }
